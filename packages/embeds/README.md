...
> [`@revinel/react`](https://www.npmjs.com/package/@revinel/react) (React) instead; they depend
> on this package and expose a friendlier API. Reach for `@revinel/embeds` only when building a
